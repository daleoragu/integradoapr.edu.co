...
class FichaEstudiante(models.Model):
    ...
    # --- CAMPOS DE DOCUMENTO ACTUALIZADOS ---
    ...
    # --- CAMPO GRUPO SANGUÍNEO ACTUALIZADO ---
    grupo_sanguineo = models.CharField(max_length=3, choices=GRUPO_SANGUINEO_CHOICES, blank=True, verbose_name="Grupo Sanguíneo y RH")
    ...
    celular_acudiente = models.CharField(max_length=20, blank=True)
    email_acudiente = models.EmailField(blank=True)
    espera_en_porteria = models.BooleanField(default=False)
    colegio_anterior = models.CharField(max_length=200, blank=True)
    grado_anterior = models.CharField(max_length=20, blank=True)
